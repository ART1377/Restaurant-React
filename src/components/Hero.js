...
const Hero = () => {
  return (
    <>
      <div className={`container-fluid ${css["main-conteiner"]}`}>
        <div className={`row px-lg-5 px-sm-3 ${css["hero-row"]}`}>
          <div className={`col-sm-6 pt-sm-5 ${css["hero-content"]}`}>
            ...
            <p className={`pt-3 ${css["hero-text"]}`}>
              لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
              استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه که لازم
              است
            </p>
            <div className={`d-flex py-3 pt-lg-5 ${css['hero-button']}`}>
          ...
          <div className={`col-sm-6 ps-0 pt-sm-0  ${css["hero-image"]}`}>
            <img
              src={HeroImageMd}
              alt="HeroImage"
